...
<body>
     ...
     <div class="header">
          ...
          <a href="Homepage.php"><img id="logo" src="farmket.png"></a>
...
<table>
        <tr id="protitle">
            <td>
                <div class="grp1">
                    ...
                    <div class="col2"><label class="text1" name="product_title" required>Prashan</label>
            </td>
            </div>
            </div>
            <td>
                <div class="grp2">
                    ...
                    <div class="col4">
                    <label class="text1" name="product_title" >9742436283</label>            </div>
        ...
        <tr id="protitle">
            <td>
                <div class="grp1">
                    ...
                    <div class="col2"><label class="text1" name="product_title" required>Thulobhyarang</label>
            </td>
            </div>
            </div>
            <td>
        ...
        <tr>  
             <td>
                ...
                <div class="grp1 movedown">
                    ...
                    <div class="col2"><label class="text1" name="product_title" required>3:20 pm</label>
            </td>
            </div>
            </div>
            <td>
          ...
          <tr><td>
                <div class="grp1">
                    ...
                    <div class="col2"><label class="text1" name="product_title" required>Mango</label>
            </td>
            </div>
            </div>
     ...
     <div class="footer">
          ...
          <div class="esewa"><img src="../Images/Website/esewa.png" height="75px" width="125px"></div>
     </div><br><br>
     ...
     <div class="morefooter">
          ...
          <div class="call">
               ...
               <a href="#" style="color:black;">9742436283</a>
          </div>
     ...
     <div class="instaid">
          <div class="text"><a href="#" style="color:black;">@Farmket</a></div>

          <div class="gmailid">
               <a href="#" class="hypher" style="color:black;">farmket@gmail.com</a>
          </div>

     </div>
     <div class="copy">
          <h5 style="test-align:center; padding-top:40px;margin-left:650px; background-color:'grey';">Copyright &copy; 2022 by www.farmket.com</h5>
     </div>
